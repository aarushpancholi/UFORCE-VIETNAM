...
//        turret.setAutoAim(true);
        ...
        SequentialCommandGroup autonomousSequence = new SequentialCommandGroup(
                ...
                new ParallelCommandGroup(
                        ...
                        new setShooter(shooter, 1320, angleFromDistance(getRedDistance(new Pose(p2End.getX(), p2End.getY())))),
                ...
                new WaitCommand(500),
                new ParallelCommandGroup(
//                        new setShooter(shooter, 1350, angleFromDistance(getRedDistance(p2End))),
...
//                        new setShooter(shooter, 1350, angleFromDistance(getRedDistance(p2End))),
                ...
                new WaitCommand(500),
                new ParallelCommandGroup(
//                        new setShooter(shooter, 1300, angleFromDistance(getRedDistance(new Pose(p4End.getX() + 10, p4End.getY())))),
                        new transfer(intake, false)
                                .alongWith(new InstantCommand(() -> intake.intake2Off())),
                ...
                new ParallelCommandGroup(
                        new transfer(intake, false)
                                .alongWith(new InstantCommand(() -> intake.intake2Off())),
//                        new setShooter(shooter, 1300, angleFromDistance(getRedDistance(p6End))),
