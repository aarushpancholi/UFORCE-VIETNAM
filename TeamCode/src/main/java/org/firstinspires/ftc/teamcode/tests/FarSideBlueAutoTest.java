...
public class FarSideBlueAutoTest extends CommandOpMode {
    ...
    private static final double H180  = Math.toRadians(0);
    ...
    private final Pose startPose = new Pose(125.526, 18, H135);

    private final Pose p1End  = new Pose(87.431, 89.214, H135).mirror();
    private final Pose p2End  = new Pose(104.587, 83.383, H180).mirror();
    private final Pose p3End  = new Pose(130.264, 83.921, H180).mirror();
    private final Pose p4End  = new Pose(81.889, 81.420, H135).mirror();
    private final Pose p5End  = new Pose(104.886, 59.284).mirror();

    private final Pose p6CP   = new Pose(126.585, 56.610).mirror();
    private final Pose p6End  = new Pose(129.823, 56.361, H180).mirror();

    private final Pose p8CP   = new Pose(117.203, 53.168).mirror();
    private final Pose p8End  = new Pose(134, 56.7, H145).mirror();

    private final Pose p9End = new Pose(105.126, 35.187).mirror();
    private final Pose p10End = new Pose(135.216, 35.051, H180).mirror();
    private final Pose p11End = new Pose(84.078, 20.858, Math.toRadians(125)).mirror();
    private final Pose p12End = new Pose(84.207, 27.152, Math.toRadians(125)).mirror();
